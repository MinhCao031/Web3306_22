        ...
        <Container>
            <div className="wrapper">
                ...
                <div className="wrapper">
                    ...
                    <CustomDialog value="Quên mật khẩu?" title="Quên mật khẩu?" type="span">
                        Vui lòng liên hệ với phòng đào tạo theo số điện thoại 0123456789 hoặc pđt@gmail.com để được hỗ
                        trợ.
                    </CustomDialog>
                </div>
            </div>
...
const Button = styled.button`
    ...
    cursor: pointer;
`;
const InputField = styled.div`position: relative;`;
